...
import { getLogo } from '../utils/data'
      ...
      <footer className="rounded-lg bg-black p-4 shadow dark:bg-black md:flex md:items-center md:justify-between md:p-6">
        ...
        '>
          <div className='mb-6 md:mb-0 bg-white
            rounded-full 4 shadow-md
             h-14 w-14 flex items-center justify-center
              md:h-20 md:w-20'>
            <a href='https://pragmaticslab.com/' className='flex items-center'>
              <Image src={logo} alt='Pragmaticslab' width={100} height={100} />
            </a>
          </div>
        </div>

        <span className="text-sm text-gray-500 dark:text-gray-300 sm:text-center">© 2023 <a
          href="https://pragmaticslab.com/">Pragmatics Lab</a>. All Rights Reserved.
        </span>
          <div className="flex mt-4 space-x-6 sm:justify-center md:mt-0">
            <a href="https://github.com/pragmaticslaboratory/SBABM" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
            ...
            <a href="https://www.linkedin.com/company/pragmaticslab" className="text-gray-400 hover:text-gray-900 dark:hover:text-white">
              <svg className="w-5 h-5" fill="currentColor" viewBox="0 0 24 24" aria-hidden="true">
                <path fillRule="evenodd"
            ...
            {/*//a para linkedn*/}
            <a  href="https://www.linkedin.com/company/pragmaticslab" className="">
